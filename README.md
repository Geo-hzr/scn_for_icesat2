...
1. Prepare and put training samples in [train_data](train_data), where each training sample is a scene of ATL03 data (in the polar stereographic coordinate system) with a specific label (positive or negative).
...
3. Use [presegmentation.py](presegmentation.py) to segment a track of ATL03 data into separate scenes, the labels of which are predicted by a loaded model.
## Citation
